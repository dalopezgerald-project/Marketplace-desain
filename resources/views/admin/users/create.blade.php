                ...
                <div class="col-lg-6">
                    <div class="card card-modern">
                        <div class="card-header">
                            <h5 class="mb-0">
                                <i class="fas fa-user-circle me-2"></i>Data User Baru
                            </h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.users.store') }}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control form-control-lg @error('name') is-invalid @enderror"
                                           placeholder="Contoh: Ahmad Rizky Wijaya"
                                ...
                                <div class="alert alert-info mb-4">
                                    ...
                                    <small>
                                        Email yang Anda buat akan digunakan untuk login. Pastikan unik dan mudah diingat.<br>
                                        Password harus diingat dengan baik karena tidak bisa dipulihkan.
                                    </small>
                                </div>
                    ...
                    <div class="card card-modern">
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-warning mt-4">
                                ...
                                <small>Hanya pilih Admin untuk pengguna yang terpercaya!</small>
                            </div>
                        </div>
                    </div>
                </div>
